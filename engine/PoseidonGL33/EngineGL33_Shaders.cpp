...
static const char s_vsScreenGLSL[] =
#include <PoseidonGL33/Shaders/vsScreen.glsl.hpp>
;

// 3D mesh vertex shader with lighting, fog, and texture generation.
// Separate Proj/View/World transform.
static const char s_vsTransformGLSL[] =
#include <PoseidonGL33/Shaders/vsTransform.glsl.hpp>
;

// PSNormal — diffuse * texture + specular + fog + night vision
static const char s_psNormalGLSL[] =
#include <PoseidonGL33/Shaders/psNormal.glsl.hpp>
;
...
static const char s_vsShadowGLSL[] =
#include <PoseidonGL33/Shaders/vsShadow.glsl.hpp>
;

// PSShadow — alpha-cutout discard, output constant black + vColor.a,
// for the per-poly shadow blend path.
static const char s_psShadowGLSL[] =
#include <PoseidonGL33/Shaders/psShadow.glsl.hpp>
;

// PSFlat — vertex color passthrough (no texture)
static const char s_psFlatGLSL[] =
#include <PoseidonGL33/Shaders/psFlat.glsl.hpp>
;
